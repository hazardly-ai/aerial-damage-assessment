...
export const EXCLUDED_XBD_IDS: Record<number, Set<number>> = {
	1: new Set([
		44, 58, 62, 63, 64, 68, 97, 120, 133, 135, 139, 143, 150, 161, 182, 185, 225,
		227, 259, 283, 298, 301, 303, 304, 305, 308, 310, 326, 331, 339, 341, 342,
		364, 368, 445, 466, 498, 504, 510, 516,
