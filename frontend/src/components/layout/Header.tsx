				...
				<div className="flex justify-between items-start gap-6">
					<header>
						...
						<div className="space-y-2">
							...
							<h1 className="pb-[0.14em] text-4xl sm:text-5xl font-bold tracking-tight leading-[1.08] bg-gradient-to-r from-foreground to-foreground/50 bg-clip-text text-transparent font-sans">
								{TEAM_NAME}
							</h1>
